...
class CRUDemployees():
    ...
    def create_employees():
        ...
        if request.method == 'POST':
            ...
            sql = 'INSERT Funcionarios (Funcionario_nome, Funcionario_CPF, Funcionario_dt_nasc, Funcionario_email, Funcionario_telefone, Funcionario_salario, Cargo_id) VALUES (?, ?, CONVERT(DATE, ?, 120), ?, ?, ?, ?)'
    ...
    def update_employees(id):
        ...
        if request.method == 'POST':
            ...
            sql = 'UPDATE Funcionarios SET Funcionario_nome = ?, Funcionario_CPF = ?, Funcionario_dt_nasc = ?, Funcionario_email = ?, Funcionario_telefone = ?, Funcionario_salario = ?, Cargo_id = ? WHERE Funcionario_id = ?'
        ...
        sqlEMP = 'SELECT * FROM Funcionarios WHERE Funcionario_id = ?'
